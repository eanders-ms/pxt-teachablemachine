...
type ExtensionMessage = PingMessage | PongMessage | HelloMessage | InitMessage | PredictionsMessage;
...
export function sendPredictions(modelType: "image" | "pose" | "sound", predictions: Prediction[]) {
